...
class Rich_Text_No_Media_Field extends Textarea_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		# Enqueue JS
		wp_enqueue_script( 'carbon-field-rich-text-no-media', $root_uri . '/assets/js/bundle.js', array( 'carbon-fields-boot' ) );

		# Enqueue CSS
		wp_enqueue_style( 'carbon-field-rich-text-no-media', $root_uri . '/assets/css/field.css' );
	}
